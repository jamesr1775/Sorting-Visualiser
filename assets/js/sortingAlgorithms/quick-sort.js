...
export function getQuickSortInfoString(){
    let quickSortInfoString = `<h2 id="algo-header">Quick Sort Algorithm</h2>
                                ...
                                are then shifted depending on if they are greater or smaller then the pivot element. Quick sort is also a divide and conquer algorithm and thus after elements in the array have been shifted in relation to the pivot element,
                                ...
                                Picking a skewed pivot value can cause the algorithms performance to get worse drastically. Thus what will average and the worst case time complexity be? Take the quiz below to find out!</p>
    `
